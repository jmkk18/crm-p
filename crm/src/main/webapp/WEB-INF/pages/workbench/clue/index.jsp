...
<script type="text/javascript">
	...
	function queryClueByConditionForPage(pageNo,pageSize){
		//获取参数
		var fullname=$("#c-fullname").val();
		var company=$("#c-company").val();
		var phone=$("#c-phone").val();
		var source=$("#c-source").val();
		var owner=$("#c-owner").val();
		var mphone=$("#c-mphone").val();
	...
	<div style="position: relative; top: -20px; left: 0px; width: 100%; height: 100%;">
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="height: 80px;">
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" type="text" id="c-fullname">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" type="text" id="c-company">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" type="text" id="c-phone">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" type="text" id="c-owner">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" type="text" id="c-mphone">
				    </div>
				  </div>
				...
				<input type="button" id="queryClueBtn" value="查询">
				</form>
			</div>
