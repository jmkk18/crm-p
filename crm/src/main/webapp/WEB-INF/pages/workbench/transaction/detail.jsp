...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<c:forEach items="${requestScope.stageList}" var="stage">
			...
			<c:if test="${requestScope.tran.stage==stage.value}">
	...
	<div style="position: relative; top: 0px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 40px;">
			...
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${requestScope.tran.name}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
	...
	<div style="position: relative; top: 100px; left: 40px;">
		...
		<c:forEach items="${requestScope.tranRemarkList}" var="tr">
			<div class="remarkDiv" style="height: 60px;">
				<img title="zhangsan" src="image/user-thumbnail.png" style="width: 30px; height:30px;">
				<div style="position: relative; top: -40px; left: 40px;" >
					<h5>${tr.noteContent}</h5>
					<font color="gray">交易</font> <font color="gray">-</font> <b>${requestScope.tran.name}</b> <small style="color: gray;"> ${tr.editFlag=='0'?tr.createTime:tr.editTime} ${tr.editFlag=='0'?tr.createBy:tr.editBy}${tr.editFlag=='0'?'创建':'修改'}</small>
		...
		<div style="position: relative; top: 100px; left: 40px;">
			...
			<div style="position: relative;top: 0px;">
				<table id="activityTable" class="table table-hover" style="width: 900px;">
					...
					<tbody>
						<c:forEach items="${requestScope.tranHistoryList}" var="th">
							<tr>
								<td>${th.stage}</td>
								<td>${th.money}</td>
